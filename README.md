...
- **Golang**
  ...
  - Интерфейсы и структуры (Interfaces & Structs)
    - [Интерфейсы изнутри в Golang // курс «Golang Developer. Professional»](https://www.youtube.com/watch?v=nOlkEqftxWg)
    - [Зачем нужны интерфейсы в #Go? / туториал по интерфейсам в #Golang (from this timing](https://www.youtube.com/watch?v=7Cmp8ySxauc&t=448s)
