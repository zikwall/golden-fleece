...
1. **Golang**
    ...
    1. Каналы и операции над нами (Channels)
        1. [Как на самом деле устроены каналы в Golang? | Golang channels internals](https://www.youtube.com/watch?v=ZTJcaP4G4JM)
    ...
    1. Карты (Maps)
        1. [Хэш-таблицы за 10 минут](https://www.youtube.com/watch?v=0UX4MIfOMEs)
        1. [Как на самом деле устроен тип Map в Golang? | Golang под капотом](https://www.youtube.com/watch?v=P_SXTUiA-9Y)
    1. Интерфейсы и структуры (Interfaces & Structs)
        1. [Интерфейсы изнутри в Golang // курс «Golang Developer. Professional»](https://www.youtube.com/watch?v=nOlkEqftxWg)
        1. [Зачем нужны интерфейсы в #Go? / туториал по интерфейсам в #Golang (from this timing](https://www.youtube.com/watch?v=7Cmp8ySxauc&t=448s)
        1. [Почему интерфейсы лучше размещать в месте использования - GoLang best practices](https://www.youtube.com/watch?v=eYHCCht8eX4)
